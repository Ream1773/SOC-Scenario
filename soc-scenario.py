...
class Scenario:
    ...
    def win_event_gen(self):
        ...
        subprocess.call(f'{self.PS} New-ADUser -Name "test987" -SamAccountName "test987" -UserPrincipalName "test987@{domain}" -AccountPassword (ConvertTo-SecureString "P@55w0rd!" -AsPlainText -Force) -Enabled $true -PasswordNeverExpires $true', shell=True)
...
if __name__ == '__main__':
    ...
    obj = Scenario(PS=PS).win_event_gen()